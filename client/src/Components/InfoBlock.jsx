    ...
    return (
        <>
            <Grid container gap={1} sx={{ display: 'flex', justifyContent: 'space-around' }}>
                <ModalContacts handleClose={handleClose} open={open} title={info?.title}/>
                <Grid item xs={12}>
                ...
                <Grid item lg={2.8} md={12} xs={12} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: {xs: 'center', sm: 'flex-start'} }}>
                    ...
                    <Button variant="contained" color="secondary" onClick={handleOpen} sx={{marginTop: '40px', width: {xs: '80%', sm: '50%', md: '80%'},marginBottom: {xs: '20px'}}}>
